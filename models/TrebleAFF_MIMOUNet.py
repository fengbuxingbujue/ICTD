...
class AFF(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.conv = nn.Sequential(
            ...
            # BasicConv(out_channel, out_channel, kernel_size=3, stride=1, relu=False)
            # 原本是两层，现在额外添加一层BasicConv(out_channel, out_channel, kernel_size=3, stride=1, relu=False)
        )
...
class MIMOUNet(nn.Module):
    ...
    def forward(self, x, t):
        ...
        # print(f'z21.shape={z21.shape}')
        z42 = F.interpolate(z, scale_factor=2)
        # print(f'z42.shape={z42.shape}')
        z41 = F.interpolate(z42, scale_factor=2)
        # print(f'z41.shape={z41.shape}')
        z14 = F.interpolate(F.interpolate(res1, scale_factor=0.5), scale_factor=0.5)
        # print(f'z14.shape={z14.shape}')
        z24 = F.interpolate(res2, scale_factor=0.5)
        # print(f'z24.shape={z24.shape}')

        
        z = self.AFFs[2](z14, z24, z)
        # print(f'z.shape={z.shape}')
        res2 = self.AFFs[1](z12, res2, z42)
        # print(f'AFF_res2.shape={res2.shape}')
        res1 = self.AFFs[0](res1, z21, z41)
        # print(f'AFF_res1.shape={res1.shape}')
